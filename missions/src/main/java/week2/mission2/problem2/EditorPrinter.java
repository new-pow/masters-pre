...
public class EditorPrinter {
    private static final String editorOn = "점수 정보 수정 1, 뒤로 2 >> ";
    private static final String selectStudent = "수정할 학생의 아이디를 입력하세요 >> ";
    private static final String selectSubject = "수정할 과목을 입력하세요 >> ";
    ...
    private static final String errorFindSubject = "해당 과목이 없습니다.";
